...
def get_opts():
    ...
    parser.add_argument(
        "--feat_base_channel", type=int, default=8, help="channel num for base feature"
    )
    parser.add_argument(
        "--reg_base_channel", type=int, default=8, help="channel num for regularization"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr_scheduler", type=str, default="MS", help="scheduler for learning rate"
    )
    ...
    parser.add_argument(
        "--summary_freq", type=int, default=100, help="print and summary frequency"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--notensorboard", action="store_true", help="do not log into tensorboard"
    )
    parser.add_argument(
