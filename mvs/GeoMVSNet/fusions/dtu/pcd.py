...
parser.add_argument(
    "--testlist", default="datasets/lists/dtu/test.txt", help="testing scene list"
)
...
parser.add_argument(
    "--nolog", action="store_true", help="do not logging into .log file"
)
parser.add_argument(
    "--plydir", default="./outputs/[exp_name]/pcd_fusion_plys/", help="output dir"
)
...
def pcd_filter_worker(scan):
    ...
    filter_depth(
        pair_folder, scan_folder, out_folder, os.path.join(args.plydir, save_name)
    )
